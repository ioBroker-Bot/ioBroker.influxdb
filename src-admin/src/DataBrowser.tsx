...
export default class DataBrowser extends ConfigGeneric<ConfigGenericProps, DataBrowserState> {
                ...
                >
                    ...
                    {!points.length && !this.state.loadingPoints ? (
                        <Typography style={{ padding: 16, opacity: 0.7 }}>
                            {I18n.t(this.state.filter ? 'influxdb_no_data' : 'influxdb_no_datapoints')}
                        </Typography>
                    ) : null}
                </List>
            </Paper>
    ...
    renderToolbar(): React.JSX.Element {
        ...
        return (
            <div style={styles.toolbar}>
                ...
                <Tooltip title={I18n.t('influxdb_range_start')}>
                    <TextField
                        variant="outlined"
                        size="small"
                ...
                <Tooltip title={I18n.t('influxdb_range_end')}>
                    <TextField
                        variant="outlined"
                        size="small"
                        style={styles.dateField}
                ...
                <Tooltip title={I18n.t(this.state.sort === 'desc' ? 'influxdb_sort_desc' : 'influxdb_sort_asc')}>
                    <IconButton
                        size="small"
                        onClick={() =>
                            this.setState(
                ...
                <Typography style={styles.pageInfo}>
                    {I18n.t('influxdb_page', first.toString(), last.toString(), total.toString())}
                </Typography>
                <IconButton
                    size="small"
                    disabled={!page}
                ...
                <Tooltip title={I18n.t('influxdb_add')}>
                    <IconButton
                        size="small"
                        color="primary"
                        onClick={() =>
                ...
                <Tooltip title={I18n.t('influxdb_delete_selected')}>
                    <span>
                        <IconButton
                            size="small"
                            ...
                            onClick={() =>
                                this.setState({
                                    confirmText: I18n.t(
                                        'influxdb_confirm_delete',
                                        this.state.checked.length.toString(),
                                    ),
        ...
        return (
            <div style={styles.table}>
                ...
                >
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell>{I18n.t('influxdb_time')}</TableCell>
                            <TableCell>{I18n.t('influxdb_value')}</TableCell>
                            <TableCell>{I18n.t('influxdb_ack')}</TableCell>
                            <TableCell>{I18n.t('influxdb_quality')}</TableCell>
                            <TableCell>{I18n.t('influxdb_from')}</TableCell>
                            <TableCell />
                        </TableRow>
                    </TableHead>
                    <TableBody>
                            ...
                            >
                                ...
                                <TableCell padding="none">
                                    ...
                                    <IconButton
                                        ...
                                        onClick={() =>
                                            this.setState({
                                                confirmText: I18n.t('influxdb_confirm_delete_one', formatTs(row.ts)),
                ...
                {!this.state.rows.length && !this.state.loadingRows ? (
                    <Typography style={{ padding: 16, opacity: 0.7 }}>{I18n.t('influxdb_no_data')}</Typography>
                ) : null}
            </div>
        );
    }
    ...
    renderEntryDialog(): React.JSX.Element | null {
        ...
        return (
            ...
            >
                <DialogTitle>{I18n.t(dialog.original ? 'influxdb_save' : 'influxdb_add')}</DialogTitle>
                <DialogContent style={{ display: 'flex', flexDirection: 'column', gap: 16, paddingTop: 8 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                        ...
                        />
                        <Typography>{I18n.t('influxdb_ack')}</Typography>
                        <TextField
                            label={I18n.t('influxdb_quality')}
                            value={dialog.q}
                            type="number"
    ...
    renderConfirmDialog(): React.JSX.Element | null {
        ...
        return (
            ...
            >
                <DialogTitle>{I18n.t('influxdb_delete')}</DialogTitle>
    ...
    renderItem(): React.JSX.Element {
        if (!this.props.alive) {
            return <Alert severity="info">{I18n.t('influxdb_instance_not_alive')}</Alert>;
        }
            ...
            <Box style={styles.root}>
                ...
                <Paper style={styles.data}>
                    ...
                    {this.state.selected ? (
                        ...
                        <Typography style={{ padding: 16, opacity: 0.7 }}>
                            {I18n.t('influxdb_select_datapoint')}
                        </Typography>
                    )}
                </Paper>
